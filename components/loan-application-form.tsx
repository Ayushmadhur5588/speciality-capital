...
export function LoanApplicationForm() {
  ...
  const [successData, setSuccessData] = useState<{ sysId: string; number: string } | null>(null)
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!sysId || !number) throw new Error("Missing sys_id or reference_number in response")

      // 2️⃣ Attachment upload
